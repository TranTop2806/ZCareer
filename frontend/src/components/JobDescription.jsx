    ...
    return (
        <>
            ...
            <div className="max-w-7xl mx-auto my-10">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            ...
                            <Badge className={"text-[#7209b7] font-bold"} variant={"ghost"}>{singleJob?.salary} VNĐ</Badge>
                        </div>
                    </div>
                    <Button
                ...
                <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-800'>{singleJob?.salary}VNĐ</span></h1>
